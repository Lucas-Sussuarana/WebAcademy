...
-- Eventos
--
CREATE DEFINER=`root`@`127.0.0.1` EVENT `RESETA_UNI` ON SCHEDULE EVERY 24 HOUR STARTS '2024-05-16 16:28:24' ENDS '2024-05-17 16:30:24' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cartao SET cartao.cartao_maxunidades=6 WHERE cartao.cartao_categoria_fk = 1$$
